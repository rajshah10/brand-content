                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
                        {(selectedOption === "brand" || type === "brand") && (
                            <div className='bg-slate-800 rounded-md bg-opacity-80 py-4 px-4 flex flex-col justify-center gap-4'>
                                ...
                                <p className="mt-4 text-lg leading-relaxed text-white">Ready to level up?</p>
                                {/* <p className="mt-4 text-lg leading-relaxed text-white">
                                    <span className='text-white font-medium'>Already have an account? </span><span className='cursor-pointer text-cyan-300' onClick={() => navigate("/login")}>login here</span>
                                </p>
