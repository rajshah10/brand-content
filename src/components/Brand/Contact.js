                        ...
                        <div class="container">
                            ...
                            <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                                <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                                    <div>
                                        <span class="inline-block p-3 text-indigo-500 rounded-full bg-indigo-100 ">
                                        ...
                                        <p class="mt-2 text-sm text-indigo-500">hello@merakiui.com</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-gray-500">Our friendly team is here to help.</p>
                                        <p class="mt-2 text-sm text-indigo-500">Start new chat</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-indigo-500">100 Smith Street Collingwood VIC 3066 AU</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-indigo-500">+1 (555) 000-0000</p>
                                    </div>
                                </div>
