                                ...
                                <div className="md:pr-12">
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            id="panel1a-header"
                                        >
                                            <Typography>WHAT IS EQUELLENCE?</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <Typography>
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            id="panel2a-header"
                                        >
                                            <Typography>WHAT CAN I DO TO JOIN AS A CONTENT CREATOR?</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <Typography>
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            id="panel3a-header"
                                        >
                                            <Typography>WHAT DO I GET WHEN I JOIN?</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <Typography>
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            id="panel4a-header"
                                        >
                                            <Typography>WHAT IS MY EXPECTATION AS A MEMBER?</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <Typography>
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            id="panel5a-header"
                                        >
                                            <Typography>DO I NEED TO PAY ANYTHING?</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <Typography>
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            id="panel6a-header"
                                        >
                                            <Typography>WHERE CAN I BUY TICKETS FOR EQUELLENCE EVENTS?</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <Typography>
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            id="panel7a-header"
                                        >
                                            <Typography>DO I NEED TO BE AN EQUESTRIAN TO JOIN?</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <Typography>
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            id="panel8a-header"
                                        >
                                            <Typography>DO YOU ACCEPT EQUESTRIANS OF ALL BACKGROUNDS?</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            <Typography>
